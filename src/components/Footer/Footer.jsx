    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            <p className="footer-description">
              Streamlining internship management for better learning outcomes and efficient workflow.
            </p>
          </div>
          ...
          {/* Contact */}
          <div className="footer-column">
            <h4 className="footer-heading">Contact HR</h4>
            <ul className="footer-contact">
              <li>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>support@sms.com</span>
              </li>
              <li>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} Student Management System. All rights reserved.</p>
